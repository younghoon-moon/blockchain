...
블록체인에 기록된 스마트 컨트랙트는 특정 계약을 무조건적으로 이행할 수 있도록 한다. 이러한 스마트 컨트랙트는 스마트 사물들이 서로간에 계약을 체결 및 이행할 수 있도록 함으로써 다양한 종류의 계약활동을 효율적이고 객관적으로 자동화시킬 수 있도록 해준다. 효율적이고 객관적인 계약의 자동화는 1. 인간의 개입이 많으며 2. 분쟁의 소지가 크고 3. 비효율적인 
