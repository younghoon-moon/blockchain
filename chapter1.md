...
#### 합의 메커니즘\(consensus mechanism\)이란?

블록체인은 비허가성\(permission-less\) 분산화\(decentralized\) 장부로서 단일의 중앙 데이터베이스에서는 발생하지 않는 문제들이 중요하게 대두된다. 그 중 가장 중요한 문제는 "누구에게 장부 작성 권한을 부여할 것인가?"이다. 
