...
비트코인이 등장하기 이전 분산화 시스템의 가장 큰 도전과제는 악의적으로 데이터를 위변조하거나 네트워크에 대한 공격\(e.g. [서비스거부DoS 공격](https://ko.wikipedia.org/wiki/%EC%84%9C%EB%B9%84%EC%8A%A4_%EA%B1%B0%EB%B6%80_%EA%B3%B5%EA%B2%A9) 및 [시빌공격Sybil Attack ](https://en.wikipedia.org/wiki/Sybil_attack)등\)을 시행하는 경우 데이터의 유효성과 무결성에 대해 어떻게 합의에 이를까하는 문제였다.
